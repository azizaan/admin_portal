...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="a_main_dashboard.php">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?php if ($online == 1) echo '<span class="status-online">Online</span>';
                                                        else echo '<span class="status-offline">Offline</span>'; ?></td>
                                                    <td>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; CODETECH 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
